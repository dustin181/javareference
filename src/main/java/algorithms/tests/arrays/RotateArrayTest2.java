...
public class RotateArrayTest2 {
    ...
    public void RotateArrayBy1PlacesRight(){
        ...
        String actual = RotateArray.rotateByNRightInPlace(input, 1);
    ...
    public void RotateArrayBy2PlacesRight(){
        ...
        String expected = Arrays.toString(intExpected);
        String actual = RotateArray.rotateByNRightInPlace(input, 2);
    ...
    public void RotateArrayBy3PlacesRight(){
        ...
        String expected = Arrays.toString(intExpected);
        String actual = RotateArray.rotateByNRightInPlace(input, 3);
    ...
    public void RotateArrayBy1PlacesLeft(){
        ...
        String expected = Arrays.toString(intExpected);
        String actual = RotateArray.rotateByNLeftInPlace(input, 1);
    ...
    public void RotateArrayBy2PlacesLeft(){
        ...
        String expected = Arrays.toString(intExpected);
        String actual = RotateArray.rotateByNLeftInPlace(input, 2);
    ...
    public void RotateArrayBy3PlacesLeft(){
        ...
        String expected = Arrays.toString(intExpected);
        String actual = RotateArray.rotateByNLeftInPlace(input, 3);
